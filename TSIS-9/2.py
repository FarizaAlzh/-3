...
apple = pygame.image.load('TSIS-8/image lab 8/3263dbbe79bb3e1.png').convert_alpha()#getting apple image
golden = pygame.image.load('TSIS-8/image lab 8/915-9155022_golden-apple-yoshis-island-yoshi-sprites.png').convert_alpha()
