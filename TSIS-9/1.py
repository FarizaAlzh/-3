...
background = pygame.image.load("TSIS-8/image lab 8/road.jpg")
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("TSIS-8/image lab 8/enemy.png")
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("TSIS-8/image lab 8/car.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("TSIS-8/image lab 8/coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
...
class BigCoin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('TSIS-8/image lab 8/Копия i.jpg')
        self.rect = self.image.get_rect()
    def move(self):
        self.rect.move_ip(0, SPEED)
